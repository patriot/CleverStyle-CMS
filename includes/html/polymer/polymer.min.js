...
(function(scope) {
  ...
  var prototype = extend(Object.create(HTMLElement.prototype), {
    ...
    _register: function() {
      if (this._delay_until) {
        if (!delayed_until[this._delay_until]) {
          delayed_until[this._delay_until] = [];
        }
        delayed_until[this._delay_until].push(this);
        return;
      }
      ...
      if (delayed_until[this.name]) {
        delayed_until[this.name].forEach(function (element) {
          element.register(element.name, element.extends)
